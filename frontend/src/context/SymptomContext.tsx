...
const seedData: SymptomEntry[] = [
  {
    id: "s1",
    region: "pelvic_midline",
    type: "pain",
    severity: 7,
    qualities: ["stabbing"],
    timing: "constant",
    triggers: ["exercise"],
    notes: "sharp pain during morning jog",
  ...
  },
  {
    ...
    qualities: ["dull"],
    timing: "gradual",
    triggers: ["bowel_movement"],
    notes: "radiates down left side",
  ...
  },
  {
    ...
    timing: "constant",
    triggers: ["urination"],
    notes: "worse after holding bladder",
  ...
  },
  {
    ...
    timing: "sudden",
    triggers: [],
    notes: "heavy flow, soaking pad in 2 hours",
  ...
  },
  {
    ...
    type: "pain",
    severity: 9,
    qualities: ["stabbing", "radiating"],
    timing: "sudden",
    triggers: [],
    notes: "sharp right-sided pain with nausea",
