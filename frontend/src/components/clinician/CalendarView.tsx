...
const appointments: Record<string, { time: string; patient: typeof patients[0]; type: string }[]> = {
  '2026-02-22': [{ time: '9:00 AM', patient: patients[3], type: 'Post-Op Follow-up' }],
  '2026-02-24': [
  ...
  '2026-02-28': [{ time: '1:00 PM', patient: patients[1], type: 'Pelvic Pain Consult' }],
  '2026-03-01': [{ time: '10:00 AM', patient: patients[2], type: 'Prenatal' }],
  '2026-03-03': [{ time: '2:00 PM', patient: patients[0], type: 'Vitality Data Review' }],
  '2026-03-05': [{ time: '9:00 AM', patient: patients[3], type: 'HRV Consult' }],
    ...
    <div>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 24 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          <div style={{ width: 40, height: 40, borderRadius: 10, backgroundColor: '#fdf2f8', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      ...
      <div style={{
        backgroundColor: '#fff', borderRadius: 16, border: '1px solid #f1f5f9', overflow: 'hidden',
                  ...
                  <>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 }}>
                      <span style={{
                        ...
                        fontSize: 13, fontWeight: isCurrentDay ? 700 : 600,
                        color: isCurrentDay ? '#fff' : '#475569',
                        backgroundColor: isCurrentDay ? '#be185d' : 'transparent',
                        boxShadow: isCurrentDay ? '0 2px 8px rgba(190, 24, 93, 0.25)' : 'none'
                      }}>
                        {day}
                      </span>
                    </div>
                      ...
                      {appts.map((a, j) => {
                        ...
                        return (
                          <div key={j} style={{
                            ...
                            backgroundColor: isCritical ? '#fdf2f8' : `${urgencyColor[a.patient.urgency]}10`,
                          ...
                          >
                            <p style={{ fontSize: 11, fontWeight: 700, color: urgencyColor[a.patient.urgency], margin: 0, letterSpacing: '0.02em' }}>
                              {a.time}
                            </p>
                            <p style={{ fontSize: 12, color: '#1e293b', margin: '2px 0 0', fontWeight: 600 }}>
                              {a.patient.name}
                            </p>
