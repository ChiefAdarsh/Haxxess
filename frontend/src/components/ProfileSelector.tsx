...
export default function ProfileSelector() {
  ...
  return (
    <div style={{ padding: '12px 16px', borderTop: '1px solid #f1f5f9' }}>
      <p style={{ fontSize: 11, fontWeight: 600, color: '#94a3b8', textTransform: 'uppercase', margin: '0 0 8px', letterSpacing: '0.02em' }}>
        Cycle state
      </p>
      <select
        value={profile}
        ...
        style={{
          ...
          fontSize: 13, color: '#1f2937', backgroundColor: '#fff', cursor: 'pointer',
        }}
      >
        {PROFILES.map((p) => (
      ...
      {updating && <p style={{ fontSize: 10, color: '#94a3b8', margin: '4px 0 0' }}>Updating pipeline...</p>}
    </div>
  )
}
