...
const cachedGetJson = <T>(url: string, forceRefresh = false): Promise<T | null> => {
  const key = `GET ${url}`
...
export const fetchForecast = (
  ...
  const url = buildUrl('/intelligence/forecast', { profile: profile ?? undefined })
...
export const fetchCoaching = (
  ...
  const url = buildUrl('/intelligence/coaching', { profile: profile ?? undefined })
...
export const fetchHistory = (
  ...
  const url = buildUrl('/history/vitality', { days, profile: profile ?? undefined })
...
export const fetchSmartAlert = (
  ...
  const url = buildUrl('/intelligence/alert', { profile: profile ?? undefined })
  return cachedGetJson<string>(url, forceRefresh)
}
...
export const fetchHistoryHourly = (
  ...
  const url = buildUrl('/history/hourly', { hours, profile: profile ?? undefined })
  return cachedGetJson<string>(url, forceRefresh)
}
...
export const fetchHistoryTimeline = (
  ...
  const url = buildUrl('/history/timeline', { days, profile: profile ?? undefined })
  return cachedGetJson<string>(url, forceRefresh)
}
...
export const fetchHistoryTrends = (
  ...
  const url = buildUrl('/history/trends', { days, profile: profile ?? undefined })
  return cachedGetJson<string>(url, forceRefresh)
}
...
export const fetchWeekComparison = (
  ...
  const url = buildUrl('/history/week-comparison', { profile: profile ?? undefined })
  return cachedGetJson<string>(url, forceRefresh)
}
...
export const fetchSignalHistory = (
  ...
  const url = buildUrl(`/history/signal/${safeSignal}`, { days, profile: profile ?? undefined })
  return cachedGetJson<string>(url, forceRefresh)
}
...
export const setWearableProfile = async (profile: CycleProfile | string): Promise<string> => {
